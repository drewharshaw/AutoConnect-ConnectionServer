...
L.Marker.MovingMarker = L.Marker.extend({
  ...
  /**
   * Set the connections list for this duration
   **/
  ...
  _setCommunicating: function() {
    ...
    if (this.communicatingTime.length != 0) {
      //console.log(this.totalTimeElapsed);
      //console.log(this.communicatingTime[0]);
      //console.log(this);

      if (this.communicatingTime[0] == this.totalTimeElapsed)
        this.setIcon(this.icon.communicating);
      else this.setIcon(this.icon.standard);

      // shift the communicating stack if needed
      if (this.communicatingTime[0] <= this.totalTimeElapsed)
        this.communicatingTime.shift();
    }
  },
  ...
  _drawConnections: function() {
    ...
    this.currentConnections.forEach(marker_b => {
      ...
      this.polylines[marker_b.vid].setLatLngs([this._latlng, marker_b._latlng]);
    });
  },
  ...
  _updateLine: function(timestamp) {
    ...
    while (elapsedTime > lineDuration) {
      ...
      lineIndex++;
      this.totalTimeElapsed += lineDuration;
